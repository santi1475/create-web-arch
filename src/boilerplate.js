...
const PAGE_I18N = {
  es: {
    ...
    starterCommand: "create-web-arch generate component HeroBanner",
    secondaryCommand: "create-web-arch g service User",
...
export async function cleanBoilerplateForTest(projectPath, projectNameOrOptions, darkModeArg = false) {
  ...
  await fs.writeFile(
    ...
    await readTemplate(pageTemplate, {
      ...
      SECONDARY_COMMAND: architecture === "feature" ? "create-web-arch g feature Checkout" : copy.secondaryCommand,
